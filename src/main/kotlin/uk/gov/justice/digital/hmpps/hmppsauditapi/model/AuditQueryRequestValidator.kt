...
class AuditQueryRequestValidator : ConstraintValidator<ValidAuditQueryRequest, AuditQueryRequest> {

  override fun isValid(dto: AuditQueryRequest?, context: ConstraintValidatorContext): Boolean {
