...
@Entity(name = "PersonOnProbationAuditEvent")
@Table(name = "audit_event", schema = "person_on_probation")
@Schema(description = "Audit Event Insert Record")
data class PersonOnProbationAuditEvent(
  @Id
  @GeneratedValue
  @Hidden
  var id: UUID? = null,
...
fun PersonOnProbationAuditEvent.toAuditEvent(): AuditEvent = AuditEvent(
  id = id,
  what = what,
  `when` = `when`,
