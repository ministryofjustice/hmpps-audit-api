...
class StaffAuditServiceTest {
  ...
  inner class SaveAuditEvent {
    ...
    fun `save audit event to database when saveToS3Bucket is false`() {
      auditService = StaffAuditService(telemetryClient, staffAuditRepository, auditS3Client, auditAthenaClient, athenaPropertiesFactory, false)
    ...
    fun `save audit event to S3 bucket when saveToS3Bucket is true`() {
      ...
      auditService = StaffAuditService(telemetryClient, staffAuditRepository, auditS3Client, auditAthenaClient, athenaPropertiesFactory, true)
