...
class PrisonerDigitalServicesResourceTest : IntegrationTest() {
  ...
  fun startQuery() {
    ...
    webTestClient.post().uri("/audit/prisoner/query")
      .headers(setAuthorisation(roles = listOf("ROLE_PRISONER_AUDIT", "ROLE_QUERY_AUDIT__HMPPS_LAUNCHPAD"), scopes = listOf("read")))
      .body(
